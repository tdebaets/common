...
Common Code Utilities by Tim De Baets is Copyright © 2016-2024 Tim De Baets. It is licensed under the Apache License version 2.0, with the exception of some individual third-party files. See [LICENSE](LICENSE) for details.
