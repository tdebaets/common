 ...
 ****************************************************************************
 *
 * ActiveX import of Windows Media Player control (wmp.dll)
 *
 ****************************************************************************)
...
// File generated on 13/01/2011 22:00:15 from Type Library described below.
...
uses Windows, ActiveX, Classes, Graphics,
    {$IFDEF WMP_ACTIVEX_CONTROL} OleCtrls, {$ENDIF} StdVCL;

{$IFNDEF WMP_ACTIVEX_CONTROL}
type
...
// *********************************************************************//
// WMPPlaylistChangeEventType constants
type
...
// WMPStringCollectionChangeEventType constants
type
...
// WMPSubscriptionDownloadState constants
type
...
// WMP_WRITENAMESEX_TYPE constants
type
...
// *********************************************************************//
  _WMPOCXEvents = dispinterface
    ...
    procedure Disconnect(Result_: Integer); dispid 5401;
    ...
    procedure EndOfStream(Result_: Integer); dispid 5201;
...
// *********************************************************************//
  IWMPCore = interface(IDispatch)
    ...
    function Get_controls_: IWMPControls; safecall;
    ...
    property controls_: IWMPControls read Get_controls_;
...
// *********************************************************************//
  IWMPCoreDisp = dispinterface
    ...
    property controls_: IWMPControls readonly dispid 4;
...
// *********************************************************************//
  IWMPGraphEventHandler = interface(IDispatch)
    ...
    procedure NotifyAcquireCredentials(punkGraph: ULONG_PTR; const bstrRealm: WideString; 
                                       const bstrSite: WideString; var bstrUser: WideString; 
                                       var bstrPassword: WideString; var pdwFlags: UINT; 
    ...
    procedure NotifyLicenseDialog(punkGraph: ULONG_PTR; const bstrURL: WideString; 
                                  ...
                                  dwPostDataSize: UINT; lResult: Integer); safecall;
...
// *********************************************************************//
  IWMPGraphEventHandlerDisp = dispinterface
    ...
    procedure NotifyLicenseDialog(punkGraph: ULONG_PTR; const bstrURL: WideString; 
                                  const bstrContent: WideString; var pPostData: Byte; 
                                  dwPostDataSize: UINT; lResult: Integer); dispid 8162;
...
// *********************************************************************//
  IUPnPService_IWMPUPnPAVTransportDual = interface(IDispatch)
    ...
    function Get_NumberOfTracks: UINT; safecall;
    function Get_CurrentTrack: UINT; safecall;
    ...
    function Get_A_ARG_TYPE_InstanceID: UINT; safecall;
    procedure SetAVTransportURI(InstanceID: UINT; const CurrentURI: WideString; 
                                const CurrentURIMetaData: WideString); safecall;
    procedure SetNextAVTransportURI(InstanceID: UINT; const NextURI: WideString; 
                                    const NextURIMetaData: WideString); safecall;
    procedure GetMediaInfo(InstanceID: UINT; var pNrTracks: UINT; var pMediaDuration: WideString; 
                           var pCurrentURI: WideString; var pCurrentURIMetaData: WideString; 
                           var pNextURI: WideString; var pNextURIMetaData: WideString; 
                           var pPlayMedium: WideString; var pRecordMedium: WideString; 
                           var pWriteStatus: WideString); safecall;
    procedure GetTransportInfo(InstanceID: UINT; var pCurrentTransportState: WideString; 
                               var pCurrentTransportStatus: WideString; 
                               var pCurrentSpeed: WideString); safecall;
    procedure GetPositionInfo(InstanceID: UINT; var pTrack: UINT; var pTrackDuration: WideString; 
                              var pTrackMetaData: WideString; var pTrackURI: WideString; 
                              var pRelTime: WideString; var pAbsTime: WideString; 
                              var pRelCount: Integer; var pAbsCount: Integer); safecall;
    procedure GetDeviceCapabilities(InstanceID: UINT; var pPlayMedia: WideString; 
                                    var pRecMedia: WideString; var pRecQualityModes: WideString); safecall;
    procedure GetTransportSettings(InstanceID: UINT; var pPlayMode: WideString; 
                                   var pRecQualityMode: WideString); safecall;
    procedure stop(InstanceID: UINT); safecall;
    procedure play(InstanceID: UINT; const Speed: WideString); safecall;
    procedure pause(InstanceID: UINT); safecall;
    procedure Record_(InstanceID: UINT); safecall;
    procedure Seek(InstanceID: UINT; const Unit_: WideString; const Target: WideString); safecall;
    procedure next(InstanceID: UINT); safecall;
    procedure previous(InstanceID: UINT); safecall;
    procedure SetPlayMode(InstanceID: UINT; const NewPlayMode: WideString); safecall;
    procedure SetRecordQualityMode(InstanceID: UINT; const NewRecordQualityMode: WideString); safecall;
    procedure GetCurrentTransportActions(InstanceID: UINT; var pActions: WideString); safecall;
    ...
    property NumberOfTracks: UINT read Get_NumberOfTracks;
    property CurrentTrack: UINT read Get_CurrentTrack;
    ...
    property A_ARG_TYPE_InstanceID: UINT read Get_A_ARG_TYPE_InstanceID;
  end;
...
// *********************************************************************//
  IUPnPService_IWMPUPnPAVTransportDualDisp = dispinterface
    ...
    property NumberOfTracks: UINT readonly dispid 12;
    property CurrentTrack: UINT readonly dispid 13;
    ...
    property A_ARG_TYPE_InstanceID: UINT readonly dispid 30;
    procedure SetAVTransportURI(InstanceID: UINT; const CurrentURI: WideString; 
    ...
    procedure GetMediaInfo(InstanceID: UINT; var pNrTracks: UINT; var pMediaDuration: WideString; 
                           ...
                           var pNextURI: WideString; var pNextURIMetaData: WideString; 
                           var pPlayMedium: WideString; var pRecordMedium: WideString; 
                           var pWriteStatus: WideString); dispid 33;
    procedure GetTransportInfo(InstanceID: UINT; var pCurrentTransportState: WideString; 
                               var pCurrentTransportStatus: WideString; 
    ...
    procedure GetPositionInfo(InstanceID: UINT; var pTrack: UINT; var pTrackDuration: WideString; 
                              var pTrackMetaData: WideString; var pTrackURI: WideString; 
                              var pRelTime: WideString; var pAbsTime: WideString; 
                              var pRelCount: Integer; var pAbsCount: Integer); dispid 35;
    procedure GetDeviceCapabilities(InstanceID: UINT; var pPlayMedia: WideString; 
                                    var pRecMedia: WideString; var pRecQualityModes: WideString); dispid 36;
    procedure GetTransportSettings(InstanceID: UINT; var pPlayMode: WideString; 
                                   var pRecQualityMode: WideString); dispid 37;
    procedure stop(InstanceID: UINT); dispid 38;
    procedure play(InstanceID: UINT; const Speed: WideString); dispid 39;
    procedure pause(InstanceID: UINT); dispid 40;
    procedure Record_(InstanceID: UINT); dispid 41;
    procedure Seek(InstanceID: UINT; const Unit_: WideString; const Target: WideString); dispid 42;
    procedure next(InstanceID: UINT); dispid 43;
    procedure previous(InstanceID: UINT); dispid 44;
    procedure SetPlayMode(InstanceID: UINT; const NewPlayMode: WideString); dispid 45;
    procedure SetRecordQualityMode(InstanceID: UINT; const NewRecordQualityMode: WideString); dispid 46;
    procedure GetCurrentTransportActions(InstanceID: UINT; var pActions: WideString); dispid 47;
  end;
...
// *********************************************************************//
  IUPnPService_IWMPUPnPVariableControlDual = interface(IDispatch)
    ...
    function Get_NumberOfSteps: UINT; safecall;
    ...
    procedure GetNumberOfSteps(var pNumberOfSteps: UINT); safecall;
    ...
    property NumberOfSteps: UINT read Get_NumberOfSteps;
  end;
...
// *********************************************************************//
  IUPnPService_IWMPUPnPVariableControlDualDisp = dispinterface
    ...
    property NumberOfSteps: UINT readonly dispid 6;
    ...
    procedure GetNumberOfSteps(var pNumberOfSteps: UINT); dispid 12;
...
// *********************************************************************//
  ...
  TWindowsMediaPlayerDisconnect = procedure(Sender: TObject; Result_: Integer) of object;
  ...
  TWindowsMediaPlayerEndOfStream = procedure(Sender: TObject; Result_: Integer) of object;
  ...
  TWindowsMediaPlayerMouseUp = procedure(Sender: TObject; nButton: Smallint; nShiftState: Smallint; 
                                                          fX: Integer; fY: Integer) of object;
  TWindowsMediaPlayerDeviceConnect = procedure(Sender: TObject; const pDevice: IWMPSyncDevice) of object;
  TWindowsMediaPlayerDeviceDisconnect = procedure(Sender: TObject; const pDevice: IWMPSyncDevice) of object;
  TWindowsMediaPlayerDeviceStatusChange = procedure(Sender: TObject; const pDevice: IWMPSyncDevice; 
                                                                     NewStatus: WMPDeviceStatus) of object;
  TWindowsMediaPlayerDeviceSyncStateChange = procedure(Sender: TObject; const pDevice: IWMPSyncDevice; 
                                                                        NewState: WMPSyncState) of object;
  TWindowsMediaPlayerDeviceSyncError = procedure(Sender: TObject; const pDevice: IWMPSyncDevice; 
                                                                  const pMedia: IDispatch) of object;
  TWindowsMediaPlayerCreatePartnershipComplete = procedure(Sender: TObject; const pDevice: IWMPSyncDevice; 
                                                                            hrResult: HResult) of object;
  TWindowsMediaPlayerCdromRipStateChange = procedure(Sender: TObject; const pCdromRip: IWMPCdromRip; 
                                                                      wmprs: WMPRipState) of object;
  TWindowsMediaPlayerCdromRipMediaError = procedure(Sender: TObject; const pCdromRip: IWMPCdromRip; 
                                                                     const pMedia: IDispatch) of object;
  TWindowsMediaPlayerCdromBurnStateChange = procedure(Sender: TObject; const pCdromBurn: IWMPCdromBurn; 
                                                                       wmpbs: WMPBurnState) of object;
  TWindowsMediaPlayerCdromBurnMediaError = procedure(Sender: TObject; const pCdromBurn: IWMPCdromBurn; 
                                                                      const pMedia: IDispatch) of object;
  TWindowsMediaPlayerCdromBurnError = procedure(Sender: TObject; const pCdromBurn: IWMPCdromBurn; 
                                                                 hrError: HResult) of object;
  TWindowsMediaPlayerLibraryConnect = procedure(Sender: TObject; const pLibrary: IWMPLibrary) of object;
  TWindowsMediaPlayerLibraryDisconnect = procedure(Sender: TObject; const pLibrary: IWMPLibrary) of object;
  TWindowsMediaPlayerFolderScanStateChange = procedure(Sender: TObject; wmpfss: WMPFolderScanState) of object;
  TWindowsMediaPlayerStringCollectionChange = procedure(Sender: TObject; const pdispStringCollection: IDispatch; 
                                                                         change: WMPStringCollectionChangeEventType; 
                                                                         lCollectionIndex: Integer) of object;
  TWindowsMediaPlayerMediaCollectionMediaAdded = procedure(Sender: TObject; const pdispMedia: IDispatch) of object;
  TWindowsMediaPlayerMediaCollectionMediaRemoved = procedure(Sender: TObject; const pdispMedia: IDispatch) of object;

{$IFDEF WMP_ACTIVEX_CONTROL}
  ...
  private
    ...
    FOn_WMPOCXEvents_Click: TWindowsMediaPlayerClick;
    FOnDoubleClick: TWindowsMediaPlayerDoubleClick;
    FOn_WMPOCXEvents_KeyDown: TWindowsMediaPlayerKeyDown;
    FOn_WMPOCXEvents_KeyPress: TWindowsMediaPlayerKeyPress;
    FOn_WMPOCXEvents_KeyUp: TWindowsMediaPlayerKeyUp;
    FOn_WMPOCXEvents_MouseDown: TWindowsMediaPlayerMouseDown;
    FOn_WMPOCXEvents_MouseMove: TWindowsMediaPlayerMouseMove;
    FOn_WMPOCXEvents_MouseUp: TWindowsMediaPlayerMouseUp;
    ...
    function Get_controls_: IWMPControls;
  ...
  published
    ...
    property On_WMPOCXEvents_Click: TWindowsMediaPlayerClick read FOn_WMPOCXEvents_Click write FOn_WMPOCXEvents_Click;
    property OnDoubleClick: TWindowsMediaPlayerDoubleClick read FOnDoubleClick write FOnDoubleClick;
    property On_WMPOCXEvents_KeyDown: TWindowsMediaPlayerKeyDown read FOn_WMPOCXEvents_KeyDown write FOn_WMPOCXEvents_KeyDown;
    property On_WMPOCXEvents_KeyPress: TWindowsMediaPlayerKeyPress read FOn_WMPOCXEvents_KeyPress write FOn_WMPOCXEvents_KeyPress;
    property On_WMPOCXEvents_KeyUp: TWindowsMediaPlayerKeyUp read FOn_WMPOCXEvents_KeyUp write FOn_WMPOCXEvents_KeyUp;
    property On_WMPOCXEvents_MouseDown: TWindowsMediaPlayerMouseDown read FOn_WMPOCXEvents_MouseDown write FOn_WMPOCXEvents_MouseDown;
    property On_WMPOCXEvents_MouseMove: TWindowsMediaPlayerMouseMove read FOn_WMPOCXEvents_MouseMove write FOn_WMPOCXEvents_MouseMove;
    property On_WMPOCXEvents_MouseUp: TWindowsMediaPlayerMouseUp read FOn_WMPOCXEvents_MouseUp write FOn_WMPOCXEvents_MouseUp;
...
begin
  Result := ControlInterface.Get_dvd;
end;

function TWindowsMediaPlayer.Get_playerApplication: IWMPPlayerApplication;
begin
  Result := ControlInterface.Get_playerApplication;
end;
