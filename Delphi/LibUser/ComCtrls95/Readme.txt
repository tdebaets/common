...
hope to have those out of the way with the next public release. 
...
03/08/99 - I've finally found so old code I had done for a guy at work
concerning disabled tab text.  I've added that to TPage95Control and
it seems to be working for both Horizontal and Vertical text as well
as both static and truetype fonts. (I'm actually quite impressed by 
that fact!) To use this feature you enable/disable the actual 
TTab95Sheet.  It will then visibly change the tab text to show the 
current state.  I'm still trying to work out the BCB3 story.  I've 
narrowed it down to variations between D3-BCB3-D4 compilers.  What it
is exactly though I still haven't got a clue.  I may have to break down
and purchase a copy of BCB3 to figure it out. (v2.93)

06/30/99 - I've corrected another bug that was found by Peter van der Linden
regarding the OnChange event and Accelerator key in the tabs.  The OnChange
event is now firing off when the appropriate accelerator key is hit.

09/21/99 - I've updated the controls to now correctly with D5.  I've taken 
a long time to get back to this set of controls.  I've decided that I'm no 
longer going to actively support this set of controls.  This means that I 
will not be pro-active in my maintenance of the ComCtrls95.  With the 
advances made by Borland in the later versions of Delphi, and BCB, I feel 
that the ComCtrls95 are now redundant.  I've had alot of fun working on these
controls thanks to all of those who helped make it what it is.

Ryan Mills.  (Final Version 2.93)