...
uses
  ...
  {$IFNDEF COMPILER_5_UP} , ClassesNew {$ENDIF};
...
function FindSortedListByTarget(List: TNotifyList; TargetCompare: TListTargetCompare;
...
uses
  ...
  {$IFNDEF COMPILER_5_UP} , TypInfoNew {$ENDIF};
