...
{$ENDIF}
function Tnt_WStrComp(Str1, Str2: PWideChar): Integer; {$IFDEF COMPILER_5_UP} deprecated; {$ENDIF}
function Tnt_WStrPos(Str, SubStr: PWideChar): PWideChar; {$IFDEF COMPILER_5_UP} deprecated; {$ENDIF}
