...
begin
  I := ListBox.ItemIndex;
  TempData := FListBox.GetItemData(Index);
  // Set the Item to 0 in case it is an object that gets freed during Delete
  FListBox.SetItemData(Index, 0);
  Delete(Index);
  InsertObject(Index, S, nil);
  FListBox.SetItemData(Index, TempData);
  ListBox.ItemIndex := I;
end;
...
begin
  ...
  try
    ...
    TempData := FListBox.GetItemData(Index1);
    Strings[Index1] := Strings[Index2];
    FListBox.SetItemData(Index1, FListBox.GetItemData(Index2));
    Strings[Index2] := TempString;
    FListBox.SetItemData(Index2, TempData);
...
begin
  ...
  try
    ...
    begin
      ...
      TempData := FListBox.GetItemData(CurIndex);
      FListBox.SetItemData(CurIndex, 0);
      Delete(CurIndex);
      Insert(NewIndex, TempString);
      FListBox.SetItemData(NewIndex, TempData);
    end;
  finally
