...
uses
  ...
  {$IFNDEF COMPILER_5_UP} , TypInfoNew, DsgnIntf {$ENDIF};
...
type
  ...
  {$IFDEF COMPILER_4} // verified against VCL source in Delphi 4
...
begin
  ...
  if PropInfo = nil then
    raise EPropertyError.CreateFmt(SUnknownProperty, ['Caption']);
