...
uses
  ...
  UxTheme, TmSchema, CommCtrl, Common2;
...
type
  ...
  public
    ...
    function GetElementDetailsButton(Detail: TThemedButton): TThemedElementDetails;
    function GetElementDetailsClock(Detail: TThemedClock): TThemedElementDetails;
    function GetElementDetailsComboBox(Detail: TThemedComboBox): TThemedElementDetails;
    function GetElementDetailsEdit(Detail: TThemedEdit): TThemedElementDetails;
    function GetElementDetailsExplorerBar(Detail: TThemedExplorerBar): TThemedElementDetails;
    function GetElementDetailsHeader(Detail: TThemedHeader): TThemedElementDetails;
    function GetElementDetailsListView(Detail: TThemedListView): TThemedElementDetails;
    function GetElementDetailsMenu(Detail: TThemedMenu): TThemedElementDetails;
    function GetElementDetailsPage(Detail: TThemedPage): TThemedElementDetails;
    function GetElementDetailsProgress(Detail: TThemedProgress): TThemedElementDetails;
    function GetElementDetailsRebar(Detail: TThemedRebar): TThemedElementDetails;
    function GetElementDetailsScrollBar(Detail: TThemedScrollBar): TThemedElementDetails;
    function GetElementDetailsSpin(Detail: TThemedSpin): TThemedElementDetails;
    function GetElementDetailsStartPanel(Detail: TThemedStartPanel): TThemedElementDetails;
    function GetElementDetailsStatus(Detail: TThemedStatus): TThemedElementDetails;
    function GetElementDetailsTab(Detail: TThemedTab): TThemedElementDetails;
    function GetElementDetailsTaskBand(Detail: TThemedTaskBand): TThemedElementDetails;
    function GetElementDetailsTaskBar(Detail: TThemedTaskBar): TThemedElementDetails;
    function GetElementDetailsToolBar(Detail: TThemedToolBar): TThemedElementDetails;
    function GetElementDetailsToolTip(Detail: TThemedToolTip): TThemedElementDetails;
    function GetElementDetailsTrackBar(Detail: TThemedTrackBar): TThemedElementDetails;
    function GetElementDetailsTrayNotify(Detail: TThemedTrayNotify): TThemedElementDetails;
    function GetElementDetailsTreeView(Detail: TThemedTreeview): TThemedElementDetails;
    function GetElementDetailsWindow(Detail: TThemedWindow): TThemedElementDetails;

    function ColorToRGB(Color: TColor; Details: PThemedElementDetails): COLORREF;
    ...
    procedure DrawEdge(DC: HDC; Details: TThemedElementDetails; const R: TRect; Edge, Flags: Cardinal;
      ContentRect: PRect);
    procedure DrawElement(DC: HDC; Details: TThemedElementDetails; const R: TRect; ClipRect: PRect);
...
procedure UnloadThemeServices;
begin
  if Assigned(InternalThemeServices) then
...
function TThemeServices.GetElementDetailsButton(Detail: TThemedButton): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsClock(Detail: TThemedClock): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsComboBox(Detail: TThemedComboBox): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsEdit(Detail: TThemedEdit): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsExplorerBar(Detail: TThemedExplorerBar): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsHeader(Detail: TThemedHeader): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsListView(Detail: TThemedListview): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsMenu(Detail: TThemedMenu): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsPage(Detail: TThemedPage): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsProgress(Detail: TThemedProgress): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsRebar(Detail: TThemedRebar): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsScrollBar(Detail: TThemedScrollBar): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsSpin(Detail: TThemedSpin): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsStartPanel(Detail: TThemedStartPanel): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsStatus(Detail: TThemedStatus): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsTab(Detail: TThemedTab): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsTaskBand(Detail: TThemedTaskBand): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsTaskBar(Detail: TThemedTaskBar): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsToolBar(Detail: TThemedToolBar): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsToolTip(Detail: TThemedToolTip): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsTrackBar(Detail: TThemedTrackBar): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsTrayNotify(Detail: TThemedTrayNotify): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsTreeView(Detail: TThemedTreeview): TThemedElementDetails;
...
function TThemeServices.GetElementDetailsWindow(Detail: TThemedWindow): TThemedElementDetails;
...
function TThemeServices.ColorToRGB(Color: TColor; Details: PThemedElementDetails): COLORREF;
...
procedure TThemeServices.DrawParentBackground(Window: HWND; Target: HDC; Details: PThemedElementDetails;
  OnlyIfTransparent: Boolean; Bounds: PRect);
  ...
  begin
    ...
    begin
      ...
      try
        ...
        Details := GetElementDetailsEdit(teEditTextNormal);
