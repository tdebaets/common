...
function SHStrToInt(lpSrch: PChar): Integer; stdcall;
...
const
  ...
  ASSOCSTR_MAX              = 11; //  last item in enum...
...
function SHStripMneumonic(pszMenu: PChar): CHAR; stdcall;
...
function SHStrToInt; external shlwapi32 name 'StrToIntA';
...
function SHStripMneumonic; external shlwapi32 index 203;
