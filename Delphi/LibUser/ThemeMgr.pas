...
type
  ...
  private
    ...
    procedure Tab95SheetWindowProc(Control: TControl; var Message: TMessage);
...
procedure Register;
begin
  RegisterComponents('XP', [TThemeManager]);
end;
...
function TThemeManager.IsOnUnownedForm: Boolean;
begin
  Result := Assigned(Owner) and (Owner is TCustomForm)
      and not Assigned(Owner.Owner);
end;
...
begin
  ...
  FTab95SheetList := TWindowProcList.Create(Self, PreTab95SheetWindowProc, TTab95Sheet);
      ...
      case Message.Msg of
        ...
        CN_DRAWITEM: // Painting for owner drawn buttons.
          ...
          begin
            ...
            Details := ThemeServices.GetElementDetailsButton(tbPushButtonNormal);
            ThemeServices.DrawParentBackground(TWinControl(Control).Handle, DrawItemStruct.hDC, @Details, True, nil);
...
{$ifdef CheckListSupport}
  ...
  var
    ...
    begin
      ...
      Details := ThemeServices.GetElementDetailsButton(Button);
...
procedure TThemeManager.FormWindowProc(Control: TControl; var Message: TMessage);
  ...
  procedure DoInvalidate(Ctrl: TControl);
  var
    i: integer;
  begin
    ...
    begin
      ...
      for i := 0 to TWinControl(Ctrl).ControlCount - 1 do
        DoInvalidate(TWinControl(Ctrl).Controls[i]);
    end;
  end;
...
procedure TThemeManager.GroupBoxWindowProc(Control: TControl; var Message: TMessage);
  ...
  begin
    ...
    begin
      ...
      Details := ThemeServices.GetElementDetailsButton(Box);
      ThemeServices.DrawElement(DC, Details, OuterRect, nil);
        ...
        WM_NCPAINT:
          ...
          begin
            ...
            begin
              ...
              try
                Details := ThemeServices.GetElementDetailsRebar(trBandNormal);
                ThemeServices.DrawEdge(DC, Details, DrawRect, EDGE_SUNKEN, BF_RECT, nil);
              finally
                ReleaseDC(Handle, DC);
              end;
            end;
    ...
    begin
      case Message.Msg of
        ...
        WM_ERASEBKGND:
          with TWMEraseBkGnd(Message) do
          begin
            Details := ThemeServices.GetElementDetailsStatus(tsStatusRoot);
            ThemeServices.DrawElement(DC, Details, Control.ClientRect, nil);
            Message.Result := 1;
          end;
      else
        FStatusBarList.DispatchMessage(Control, Message);
        ...
        WM_ERASEBKGND:
          begin
            ...
            begin
              ...
              ThemeServices.DrawElement(DC, Details, DrawRect, nil);
            end
            else
              ThemeServices.DrawParentBackground(TWinControl(Control).Handle, DC, nil, False, nil);
            Message.Result := 1;
          end;
      else
...
procedure TThemeManager.Tab95SheetWindowProc(Control: TControl; var Message: TMessage);
  ...
  begin
    ...
    begin
      case Message.Msg of
        ...
        FTab95SheetList.DispatchMessage(Control, Message);
      end;
    end
    else
      FTab95SheetList.DispatchMessage(Control, Message);
                    ...
                    case Info.dwItemSpec of
                      ...
                      TBCD_CHANNEL: // Before re-painting channel just redo strip of background overlapped.
                        begin
                          ...
                          Offset := 0;
                          if Orientation = ComCtrls.trHorizontal then
                          begin
                            // Leave room for the focus rectangle if there is one.
                            if Focused then
                            begin
                          ...
                          Details := ThemeServices.GetElementDetailsTrackBar(ttbThumbTics);
                          ThemeServices.DrawParentBackground(Handle, Info.hDC, @Details, False, nil);
                          DeleteObject(Rgn);
  ...
  begin
    ...
    begin
      case Message.Msg of
        ...
        WM_ERASEBKGND:
          begin
            if (Control is TScrollingWinControl)
                or (Control is TIconMessage) then
        ...
        CN_CTLCOLORSTATIC:
          if Control is TCustomStaticText
            ...
            begin
              ...
              ThemeServices.DrawParentBackground(Handle, ChildDC, nil, False, nil);
              FWinControlList.DispatchMessage(Control, Message);
...
procedure TThemeManager.PreTab95SheetWindowProc(var Message: TMessage);

// Read more about this code in PreAnimateWindowProc.

begin
  Assert(Assigned(MainManager));
  MainManager.Tab95SheetWindowProc(TControl(Self), Message);
end;
...
begin
  ...
  begin
    Details := ThemeServices.GetElementDetailsToolBar(ToolButton);
    ThemeServices.DrawElement(DC, Details, R, nil);
    R := ThemeServices.ContentRect(DC, Details, R);
  end;
