...
{ TScrollingWinControl }
  ...
  protected
    ...
    procedure AutoScrollInView(AControl: TControl); // LIBFIXED_MODIFIED
...
{ TCustomForm }
  ...
  public
    ...
    function SetFocusedControl(Control: TWinControl): Boolean; virtual; // LIBFIXED_MODIFIED
    procedure Show;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          begin
            if TempControl.Perform(CM_AUTO_SCROLL_IN_VIEW, 0, Longint(Control)) = 0 then
...
begin
  if not (csReading in ComponentState) then Activate;
end;

procedure TCustomForm.CMDeactivate(var Message: TCMDeactivate);
begin
  if not (csReading in ComponentState) then Deactivate;
end;
