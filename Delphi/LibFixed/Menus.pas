...
begin
  ...
  begin
    ...
    // Order in which the shift states are included is different compared to the
    // original ShortCutToText function: original order is Shift - Ctrl - Alt,
    // here the order is more in line with other applications.
